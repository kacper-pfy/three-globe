    ...
    var initGlobe = function initGlobe() {
      if (animateIn) {
        ...
        new TWEEN.Tween({
          ...
          k: 1
        }, 600).easing(TWEEN.Easing.Quadratic.Out).onUpdate(function (_ref5) {
          var k = _ref5.k;
        ...
        new TWEEN.Tween({
          ...
          rot: 0
        }, 1200).easing(TWEEN.Easing.Quintic.Out).onUpdate(function (_ref6) {
          var rot = _ref6.rot;
